...
Not only is it open, it is also widely supported by the scientific community. The Python community is very enthusiast and active. In addition, despite being an interpreted language, it is really fast, as the main algorithms are coded using C.
